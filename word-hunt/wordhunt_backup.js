...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Improved function to try placing a word without conflicts
    ...
    for (let i = 0; i < wordSets.length; i++) {
        ...
        // Track placed cells to avoid conflicts
        const placedCells = {};
        ...
        // Verify all words are correctly placed
        ...
        for (const pos of puzzle.wordPositions) {
            ...
            if (actualWord !== pos.word) {
                ...
                console.log(`Word "${pos.word}" verified as "${actualWord}"`);
            }
        }
        ...
        // Final verification after filling random letters
